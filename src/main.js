...
app.component('VuePincodeInput', VuePincodeInput)
...
// Plugins
import { currencyFormat, formatDate, getID, generateRandomColor, encryptToken } from './plugins/filters'
app.config.globalProperties.$currencyFormat = currencyFormat
app.config.globalProperties.$formatDate = formatDate
app.config.globalProperties.$getID = getID
app.config.globalProperties.$generateRandomColor = generateRandomColor
app.config.globalProperties.$encryptToken = encryptToken
